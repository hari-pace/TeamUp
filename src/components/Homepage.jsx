  ...
  return (
    <>
      ...
      <div className="whatIsCon">
        ...
        <div
          className="descriptionCon"
          style={{ background: themeStyles.grey, color: themeStyles.text }}
        >
          <p>
            When you move to a new city, it can be hard to make new friends. We
            all have our own story, our own background and it's what makes us
            unique.
            <br />
            However, no matter where you are, sport is what unites us. And
            that's why we created TeamUp.
            <br />
            <br />
            No matter if you are footballer in need of a kickabout or just want
            a running partner, TeamUp has got you covered.
            <br />
            Search for events in your area or, even better, create one, and soon
            you could be playing a five-a-side game of basketball with
